...
Practitioners of Abrahamic religions make up over half the world’s population, and the holy texts of these faiths serve as the cornerstone for their respective beliefs and cultural traditions. Despite historical and modern-day contention between Christianity and Islam, the New Testament Gospels and the Qur’an have a deeply interconnected lineage. Shared figures bridge them conceptually, but the texts themselves are structured in fundamentally different ways. The four New Testament Gospels (Matthew, Mark, Luke, and John) are framed primarily as chronological narratives, whereas the Surahs of the Qur’an are formatted as a thematic discourse.
